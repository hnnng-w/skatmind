...
RESULT_LABEL_KEYS = {
    ...
    "Analysis method": "task.field.recommendation_method",
    "Comparison objective": "analysis.label.objective",
    "Analysis outcome": "analysis.label.outcome",
    "Search outcome": "analysis.label.search_outcome",
    "Search coverage": "analysis.label.coverage",
    "Samples per Card": "analysis.label.samples",
    "Immediate sample setting": "analysis.label.immediate_setting",
    "Metric scope": "analysis.label.metrics",
    "Information used": "analysis.label.information",
    "Skat Cards used": "analysis.label.skat",
